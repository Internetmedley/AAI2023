...
model = buildMyModel(x_train_flat[0].shape)         #60,000 plaatjes van 28 bij 28, dus (60000, 28, 28)               
model.summary()
...
"""
# de eerste laag heeft 28 * 28 dimensies, dus 784, en er zitten 128 neurons in de eerste laag, dus 784 * 128 = 100.352
# met de biases erbij opgeteld uit die laag kom je dan uit op 28 * 28 * 128 + 128 = 100.480

# voor de tweede laag is hetzelfde principe: 128 * 64 + 64 = 8256
# en voor de laatste layer is het 64 * 10 + 10 = 650 
...
baseFilenameForSave="featuremap"
...
# 1 wat je ziet is de one hot encoded visualisatie van de output laag, met 10 vakjes waarvan er 1 wit is, welke waarschijnlijk de prediction is
# 2 Dan zie je in grayscale een grid met vierkantjes die neuronen representeren, waarbij de witte vierkantjes de neurons zijn met een hoge activatie-waarde
# 3 Bij de tweede dense layer zie je hetzelfde als bij de vorige, maar dan met minder neuronen, bij mij dus 64 waarbij de witte vierkantjes de neuronen zijn met een 
# hoge activatie-waarde